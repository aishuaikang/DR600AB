...
func Load() Config {
	return Config{
		...
		O3Decrypt: O3DecryptConfig{
			Enabled:        envBool("API_O3_DECRYPT_ENABLED", false),
			Broker:         envString("API_O3_DECRYPT_BROKER", ""),
			Port:           envInt("API_O3_DECRYPT_PORT", 1883),
			Username:       envString("API_O3_DECRYPT_USERNAME", ""),
			Password:       envString("API_O3_DECRYPT_PASSWORD", ""),
